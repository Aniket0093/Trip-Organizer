...
public class RecyclerViewHolders extends RecyclerView.ViewHolder{
    ...
    public Trip trip;
    DatabaseReference dataSnapshot = FirebaseDatabase.getInstance().getReference();
    public RecyclerViewHolders(final View itemView, final List<Task> taskObject) {
        ...
        deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child(ToDoActivity.tripid).child("todo");
