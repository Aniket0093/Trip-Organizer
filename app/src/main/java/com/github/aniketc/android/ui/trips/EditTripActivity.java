...
import com.github.aniketc.android.ui.MainActivity;
import com.github.aniketc.android.utils.FirebaseUtil;
import com.github.aniketc.android.utils.MapUtil;
...
public class EditTripActivity extends AppCompatActivity
    ...
    TextView tvDate;
    @BindView(R.id.lyToDoList)
    LinearLayout lyToDoList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lyToDoList.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.lyPhotos:
                Intent intentPhotos=new Intent(this,DisplayPicturesActivity.class)
                        .putExtra("Trip", Parcels.wrap(trip));
                startActivity(intentPhotos);
                break;
            case R.id.lyToDoList:
