...
public class DestinationsFragment extends Fragment {
 ...
 //   Place searchplace;
    com.github.aniketc.android.model.Place searchplace;
    String latLong;
    RecyclerView recyclerView;
    DestinationsAdapter placesAdapter;
    ArrayList<com.github.aniketc.android.model.Place> placesList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     //   Place place = (Place) Parcels.unwrap(intent
       //         .getParcelableExtra(EXTRA_PLACE));

        searchplace = (com.github.aniketc.android.model.Place) Parcels.unwrap(intent
                         .getParcelableExtra(EXTRA_PLACE));
    ...
    public void sendrequest() {
        ...
        String apiKey = "AIzaSyAQ2bhy0OaY2giIaa8_m0M87oyIy3sPG-U";    //Replace API key
        latLong = searchplace.getLatitude() + "," + searchplace.getLongitude();
        ...
        client.get(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    placesList.addAll(com.github.aniketc.android.model.Place.fromJSONArray(resultsArray));
        ...
        if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
              ...
              //  latLong = searchplace.getLatLng().latitude + "," + searchplace.getLatLng().longitude;
                searchplace = new com.github.aniketc.android.model.Place();
